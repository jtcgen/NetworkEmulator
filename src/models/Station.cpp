...
//    
//    // Clean up interfaces
//    for (std::vector<ip::Iface*>::iterator itr = ifaces_.begin(); itr != ifaces_.end(); ++itr)
//        delete *itr;
//    
//    // Clean up lans
//    for (std::vector<ip::Host*>::iterator itr = lans_.begin(); itr != lans_.end(); ++itr)
//        delete *itr;
//    
//    // Clean up routes
//    for (std::vector<ip::Rtable*>::iterator itr = routes_.begin(); itr != routes_.end(); ++itr)
//        delete *itr;
//}
//
/////**
